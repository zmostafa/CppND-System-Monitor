...
string Process::getProcess(){
    ...
    return (this->pid + "    " + this->user + "    " + this->cpu.substr(0,5) + "    " + this->mem.substr(0,5) + "    " + this->upTime.substr(0,5) + "    " + this->cmd.substr(0,5)) ;//TODO: finish the string! this->user + "   "+ mem...cpu...upTime...;
}
